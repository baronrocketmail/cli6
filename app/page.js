...
async function getName(){
    const info = await fetch("https://server-neon-tau.vercel.app/api/name")
    return info.json()
}

async function getApplicationsOpen(){
    const applicationsOpen = await fetch("https://server-neon-tau.vercel.app/api/applicationsOpen")
